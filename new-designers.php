<?php session_start();
  ...
  if($designer!=""){
    ...
    $sql = "SELECT nd_product_designers.designer_id,product_id,product_title,hero_image,name,email,portfolio_link,picture,mini_bio FROM `nd_product_designers` LEFT JOIN `nd_Product` ON nd_Product.designer_id = nd_product_designers.designer_id WHERE  nd_product_designers.designer_id=$designer";
    ...
    //somehow came to the page without a designer
    header("Location: /new-designers-designers.php");
  }
?>
...
<?php include "includes/head.html"; ?>
  <?php include "includes/banner.html"; ?>
	...
	<main role="main">
        ...
        //because this SVG set is used elsewhere on the site, I decided to put it into one file so that all changes to the svg are made there; actual customisation is done in one loop below labeled "SVG PT 1"
        $SVGText="VIEW";
